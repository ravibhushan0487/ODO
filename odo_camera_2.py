...
parser.add_argument("--port", type=int, default=7402, help="The port on which camera server is listening.")
parser.add_argument("--ip", type=str, default="2.1.0.12", help="The ip on which camera server is listening.")
